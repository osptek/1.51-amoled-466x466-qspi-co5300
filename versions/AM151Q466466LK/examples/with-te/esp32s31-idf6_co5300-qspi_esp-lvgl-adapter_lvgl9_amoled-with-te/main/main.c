...
#define EXAMPLE_PIN_NUM_LCD_SCK     GPIO_NUM_8
#define EXAMPLE_PIN_NUM_LCD_D0      GPIO_NUM_10   // QSPI D0
#define EXAMPLE_PIN_NUM_LCD_D1      GPIO_NUM_12   // QSPI D1
#define EXAMPLE_PIN_NUM_LCD_D2      GPIO_NUM_14   // QSPI D2
#define EXAMPLE_PIN_NUM_LCD_D3      GPIO_NUM_16   // QSPI D3
#define EXAMPLE_PIN_NUM_LCD_RST     GPIO_NUM_19
#define EXAMPLE_PIN_NUM_LCD_TE      GPIO_NUM_34

#define EXAMPLE_TOUCH_I2C_SCL       GPIO_NUM_9
#define EXAMPLE_TOUCH_I2C_SDA       GPIO_NUM_11
#define EXAMPLE_TOUCH_RST           GPIO_NUM_13
#define EXAMPLE_TOUCH_INT           GPIO_NUM_15
...
#define EXAMPLE_LCD_PIXEL_CLOCK_HZ  (50 * 1000 * 1000)
...
void app_main(void)
{
    ESP_LOGI(TAG, "ESP32-S31 + CO5300 (QSPI) + CST820 + LVGL9 开始初始化...");
    ...
    spi_bus_config_t bus_config = CO5300_PANEL_BUS_QSPI_CONFIG(
        ...
        EXAMPLE_LCD_H_RES * EXAMPLE_LCD_V_RES * (LCD_COLOR_DEPTH / 8)
    );
